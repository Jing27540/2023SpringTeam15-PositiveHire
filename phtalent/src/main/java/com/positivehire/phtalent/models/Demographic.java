...
public class Demographic {
    ...
    public Demographic(String email, String officeLocations, String reportsTo, String gender, String race, String martialStatus, Integer noOfChildren, Integer numOfYearsWandOrg, String managerName, String divisionAndBusinessUnit, String education, String militartyYearsOfService, String careerGoal, String trainingHistory, String mentor, String sponsor) {
        this.email = email;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(email, demographic.email) && Objects.equals(officeLocations, demographic.officeLocations) && Objects.equals(reportsTo, demographic.reportsTo) && Objects.equals(gender, demographic.gender) && Objects.equals(race, demographic.race) && Objects.equals(martialStatus, demographic.martialStatus) && Objects.equals(noOfChildren, demographic.noOfChildren) && Objects.equals(numOfYearsWandOrg, demographic.numOfYearsWandOrg) && Objects.equals(managerName, demographic.managerName) && Objects.equals(divisionAndBusinessUnit, demographic.divisionAndBusinessUnit) && Objects.equals(education, demographic.education) && Objects.equals(militartyYearsOfService, demographic.militartyYearsOfService) && Objects.equals(careerGoal, demographic.careerGoal) && Objects.equals(trainingHistory, demographic.trainingHistory) && Objects.equals(mentor, demographic.mentor) && Objects.equals(sponsor, demographic.sponsor);
    }

    @Override
    public int hashCode() {
        return Objects.hash(email, officeLocations, reportsTo, gender, race, martialStatus, noOfChildren, numOfYearsWandOrg, managerName, divisionAndBusinessUnit, education, militartyYearsOfService, careerGoal, trainingHistory, mentor, sponsor);
    }
