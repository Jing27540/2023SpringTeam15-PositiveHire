...
public class APIDocumentControllerTest {
     /**
        ...
        public void testDocumentController() throws Exception {
            ...
            byte[] bytes = null;
            Document doc = new Document(null, 7878787, bytes);

            mvc.perform(post("/documents").contentType(MediaType.APPLICATION_JSON)
            .content(TestUtils.asJsonString(doc))).andExpect(status().isOk());
